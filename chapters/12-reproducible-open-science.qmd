...
Use the [**GitHub Repository Checklist**](/templates/pdf/github-repo-checklist.pdf){target="_blank" rel="noopener"} when setting up any new project.
...
Run the [**Reproducible Analysis Checklist**](/templates/pdf/reproducible-analysis-checklist.pdf){target="_blank" rel="noopener"} before any submission.
...
- When a project uses physical samples, keep **sample provenance and location** in **Aliquary** (@sec-aliquary) so inventory history can be traced alongside the analysis pipeline.
