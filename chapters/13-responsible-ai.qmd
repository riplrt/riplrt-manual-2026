# Responsible Use of AI in Research and Writing {#sec-responsible-ai}

AI tools (large language models, coding assistants, literature-synthesis and workflow-automation tools) are part of how modern research groups work — including ours. Used well, they accelerate good work. Used carelessly, they create integrity, privacy, and quality risks. This chapter sets our guardrails. The standalone policy in [responsible-ai-use](/policies/responsible-ai-use.qmd){target="_blank" rel="noopener"} is the authoritative reference, and the disclosure form lives at [AI-Use Disclosure Form](/templates/pdf/ai-use-disclosure.pdf){target="_blank" rel="noopener"}.
...
### AI tools and data across umbrellas

Which AI tools you may use — and which data you may put into them — depends on
your umbrella (@sec-entity-structure) and the data-governance rules
(@sec-data-governance):
...
- **RIPLRT / LLC infrastructure** — including tools built by **FERM Technologies** (the LLC's technology DBA) — is governed by LLC and sponsor terms, not by default Lynn or other institutions' approvals. <!-- VERIFY: which FERM/LLC tools are cleared for Lynn-governed data -->
