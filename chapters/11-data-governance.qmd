...
Use the [**Data-Use and Access Checklist**](/templates/pdf/data-use-access-checklist.pdf){target="_blank"} at the start of every project.
...
## Aliquary governance {#sec-aliquary-governance}

**[Aliquary](https://www.aliquary.com)** is our sample-inventory system of record (@sec-aliquary). Its data-governance profile must fit the same access and DUA discipline we apply everywhere else:
...
Access to Aliquary follows **least privilege** and need-to-know, the same as any other controlled tool: provisioned when a member's role requires sample work, recorded on the [Data-Use and Access Checklist](/templates/pdf/data-use-access-checklist.pdf) when inventory access is part of a project, and revoked at offboarding (@sec-onboarding). Aliquary does **not** replace IRB listing, CITI training, or dataset DUAs — it is inventory infrastructure sitting *under* those authorizations.
